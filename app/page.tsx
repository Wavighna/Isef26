...
const countryCategoryByName: Record<string, CategoryId> = {
  Afghanistan: "arid-dusty",
  Akrotiri: "marine-arid",
  Aland: "polar-marine",
  Albania: "temperate",
  Algeria: "desert-flat",
  "American Samoa": "marine-humid",
  Andorra: "rainy-steep",
  Angola: "humid-moderate",
  Anguilla: "marine-humid",
  Antarctica: "polar-marine",
  "Antigua and Barb.": "marine-humid",
  Argentina: "temperate",
  Armenia: "temperate",
  Aruba: "marine-arid",
  "Ashmore and Cartier Is.": "marine-arid",
  Australia: "desert-flat",
  Austria: "temperate",
  Azerbaijan: "arid-dusty",
  Bahamas: "marine-humid",
  Bahrain: "marine-arid",
  Baikonur: "arid-dusty",
  "Bajo Nuevo Bank": "marine-humid",
  Bangladesh: "humid-moderate",
  Barbados: "marine-humid",
  Belarus: "temperate",
  Belgium: "temperate",
  Belize: "humid-moderate",
  Benin: "humid-moderate",
  Bermuda: "marine-humid",
  Bhutan: "rainy-steep",
  Bolivia: "arid-dusty",
  "Bosnia and Herz.": "temperate",
  Botswana: "arid-dusty",
  "Br. Indian Ocean Ter.": "marine-humid",
  Brazil: "humid-moderate",
  "British Virgin Is.": "marine-humid",
  Brunei: "humid-moderate",
  Bulgaria: "temperate",
  "Burkina Faso": "arid-dusty",
  Burundi: "humid-moderate",
  "Cabo Verde": "marine-arid",
  Cambodia: "humid-moderate",
  Cameroon: "humid-moderate",
  Canada: "temperate",
  "Cayman Is.": "marine-humid",
  "Central African Rep.": "humid-moderate",
  Chad: "desert-flat",
  Chile: "arid-dusty",
  China: "temperate",
  "Clipperton I.": "marine-humid",
  Colombia: "rainy-steep",
  Comoros: "marine-humid",
  Congo: "humid-moderate",
  "Cook Is.": "marine-humid",
  "Coral Sea Is.": "marine-humid",
  "Costa Rica": "rainy-steep",
  "Cote d'Ivoire": "humid-moderate",
  Croatia: "temperate",
  Cuba: "marine-humid",
  Curacao: "marine-arid",
  Cyprus: "marine-arid",
  "Cyprus U.N. Buffer Zone": "marine-arid",
  Czechia: "temperate",
  "Dem. Rep. Congo": "humid-moderate",
  Denmark: "temperate",
  Dhekelia: "marine-arid",
  Djibouti: "marine-arid",
  Dominica: "marine-humid",
  "Dominican Rep.": "marine-humid",
  Ecuador: "rainy-steep",
  Egypt: "desert-flat",
  "El Salvador": "humid-moderate",
  "Eq. Guinea": "humid-moderate",
  Eritrea: "arid-dusty",
  Estonia: "temperate",
  Ethiopia: "temperate",
  eSwatini: "temperate",
  "Faeroe Is.": "polar-marine",
  "Falkland Is.": "polar-marine",
  Fiji: "marine-humid",
  Finland: "temperate",
  France: "temperate",
  "Fr. Polynesia": "marine-humid",
  "Fr. S. Antarctic Lands": "polar-marine",
  Gabon: "humid-moderate",
  Gambia: "marine-arid",
  Georgia: "rainy-steep",
  Germany: "temperate",
  Ghana: "humid-moderate",
  Gibraltar: "marine-arid",
  Greece: "temperate",
  Greenland: "polar-marine",
  Grenada: "marine-humid",
  Guam: "marine-humid",
  Guatemala: "humid-moderate",
  Guernsey: "marine-humid",
  Guinea: "humid-moderate",
  "Guinea-Bissau": "humid-moderate",
  Guyana: "humid-moderate",
  Haiti: "marine-humid",
  "Heard I. and McDonald Is.": "polar-marine",
  Honduras: "humid-moderate",
  "Hong Kong": "marine-humid",
  Hungary: "temperate",
  Iceland: "polar-marine",
  India: "humid-moderate",
  "Indian Ocean Ter.": "marine-humid",
  Indonesia: "marine-humid",
  Iran: "arid-dusty",
  Iraq: "arid-dusty",
  Ireland: "marine-humid",
  "Isle of Man": "marine-humid",
  Israel: "arid-dusty",
  Italy: "temperate",
  Jamaica: "marine-humid",
  Japan: "rainy-steep",
  Jersey: "marine-humid",
  Jordan: "arid-dusty",
  Kazakhstan: "arid-dusty",
  Kenya: "arid-dusty",
  Kiribati: "marine-humid",
  Kosovo: "temperate",
  Kuwait: "marine-arid",
  Kyrgyzstan: "arid-dusty",
  Laos: "humid-moderate",
  Latvia: "temperate",
  Lebanon: "temperate",
  Lesotho: "temperate",
  Liberia: "humid-moderate",
  Libya: "desert-flat",
  Liechtenstein: "rainy-steep",
  Lithuania: "temperate",
  Luxembourg: "temperate",
  Macao: "marine-humid",
  Macedonia: "temperate",
  Madagascar: "humid-moderate",
  Malawi: "humid-moderate",
  Malaysia: "marine-humid",
  Maldives: "marine-humid",
  Mali: "desert-flat",
  Malta: "marine-arid",
  "Marshall Is.": "marine-humid",
  Mauritania: "desert-flat",
  Mauritius: "marine-humid",
  Mexico: "arid-dusty",
  Micronesia: "marine-humid",
  Moldova: "temperate",
  Monaco: "marine-humid",
  Mongolia: "arid-dusty",
  Montenegro: "temperate",
  Montserrat: "marine-humid",
  Morocco: "arid-dusty",
  Mozambique: "marine-humid",
  Myanmar: "humid-moderate",
  "N. Cyprus": "marine-arid",
  "N. Mariana Is.": "marine-humid",
  Namibia: "desert-flat",
  Nauru: "marine-humid",
  Nepal: "rainy-steep",
  Netherlands: "temperate",
  "New Caledonia": "marine-humid",
  "New Zealand": "rainy-steep",
  Nicaragua: "humid-moderate",
  Niger: "desert-flat",
  Nigeria: "humid-moderate",
  Niue: "marine-humid",
  "Norfolk Island": "marine-humid",
  "North Korea": "temperate",
  Norway: "polar-marine",
  Oman: "marine-arid",
  Pakistan: "arid-dusty",
  Palau: "marine-humid",
  Palestine: "arid-dusty",
  Panama: "rainy-steep",
  "Papua New Guinea": "rainy-steep",
  Paraguay: "humid-moderate",
  Peru: "arid-dusty",
  Philippines: "marine-humid",
  "Pitcairn Is.": "marine-humid",
  Poland: "temperate",
  Portugal: "temperate",
  "Puerto Rico": "marine-humid",
  Qatar: "marine-arid",
  Romania: "temperate",
  Russia: "temperate",
  Rwanda: "humid-moderate",
  "S. Geo. and the Is.": "polar-marine",
  "S. Sudan": "arid-dusty",
  "Saint Helena": "marine-arid",
  "Saint Lucia": "marine-humid",
  Samoa: "marine-humid",
  "San Marino": "temperate",
  "Sao Tome and Principe": "marine-humid",
  "Saudi Arabia": "desert-flat",
  "Scarborough Reef": "marine-humid",
  Senegal: "arid-dusty",
  Serbia: "temperate",
  "Serranilla Bank": "marine-humid",
  Seychelles: "marine-humid",
  "Siachen Glacier": "rainy-steep",
  "Sierra Leone": "humid-moderate",
  Singapore: "marine-humid",
  "Sint Maarten": "marine-humid",
  Slovakia: "temperate",
  Slovenia: "rainy-steep",
  "Solomon Is.": "marine-humid",
  Somalia: "arid-dusty",
  Somaliland: "arid-dusty",
  "South Africa": "arid-dusty",
  "South Korea": "temperate",
  Spain: "temperate",
  "Spratly Is.": "marine-humid",
  "Sri Lanka": "marine-humid",
  "St. Kitts and Nevis": "marine-humid",
  "St. Pierre and Miquelon": "polar-marine",
  "St. Vin. and Gren.": "marine-humid",
  "St-Barthelemy": "marine-arid",
  "St-Martin": "marine-arid",
  Sudan: "desert-flat",
  Suriname: "humid-moderate",
  Sweden: "temperate",
  Switzerland: "rainy-steep",
  Syria: "arid-dusty",
  Taiwan: "marine-humid",
  Tajikistan: "arid-dusty",
  Tanzania: "humid-moderate",
  Thailand: "humid-moderate",
  "Timor-Leste": "marine-humid",
  Togo: "humid-moderate",
  Tonga: "marine-humid",
  "Trinidad and Tobago": "marine-humid",
  Tunisia: "arid-dusty",
  Turkey: "temperate",
  Turkmenistan: "desert-flat",
  "Turks and Caicos Is.": "marine-humid",
  Tuvalu: "marine-humid",
  "U.S. Minor Outlying Is.": "marine-humid",
  "U.S. Virgin Is.": "marine-humid",
  Uganda: "humid-moderate",
  Ukraine: "temperate",
  "United Arab Emirates": "marine-arid",
  "United Kingdom": "temperate",
  "United States of America": "temperate",
  Uruguay: "temperate",
  "USNB Guantanamo Bay": "marine-arid",
  Uzbekistan: "arid-dusty",
  Vanuatu: "marine-humid",
  Vatican: "temperate",
  Venezuela: "humid-moderate",
  Vietnam: "humid-moderate",
  "W. Sahara": "desert-flat",
  "Wallis and Futuna Is.": "marine-humid",
  Yemen: "desert-flat",
  Zambia: "arid-dusty",
  Zimbabwe: "arid-dusty"
};

const pvgisStateTiltByName: Record<string, number> = {
  Alabama: 31,
  Alaska: 52,
  "American Samoa": 17,
  Arizona: 33,
  ...
  California: 35,
  Colorado: 39,
  "Commonwealth of the Northern Mariana Islands": 16,
  Connecticut: 39,
  Delaware: 37,
...
const stateCategoryByName: Record<string, CategoryId> = {
  Alabama: "humid-moderate",
  Alaska: "polar-marine",
  "American Samoa": "marine-humid",
  Arizona: "desert-flat",
  Arkansas: "humid-moderate",
  California: "arid-dusty",
  Colorado: "arid-dusty",
  "Commonwealth of the Northern Mariana Islands": "marine-humid",
  Connecticut: "temperate",
  Delaware: "marine-humid",
  "District of Columbia": "temperate",
  Florida: "marine-humid",
  Georgia: "humid-moderate",
  Guam: "marine-humid",
  Hawaii: "marine-humid",
  Idaho: "arid-dusty",
  Illinois: "temperate",
  ...
  Iowa: "temperate",
  Kansas: "arid-dusty",
  Kentucky: "humid-moderate",
  Louisiana: "marine-humid",
  Maine: "marine-humid",
  Maryland: "marine-humid",
  Massachusetts: "marine-humid",
  Michigan: "temperate",
  Minnesota: "temperate",
  Mississippi: "humid-moderate",
  Missouri: "temperate",
  Montana: "arid-dusty",
  Nebraska: "arid-dusty",
  Nevada: "desert-flat",
  "New Hampshire": "rainy-steep",
  "New Jersey": "marine-humid",
  "New Mexico": "desert-flat",
  "New York": "temperate",
  "North Carolina": "humid-moderate",
  "North Dakota": "arid-dusty",
  Ohio: "temperate",
  Oklahoma: "arid-dusty",
  Oregon: "rainy-steep",
  Pennsylvania: "temperate",
  "Puerto Rico": "marine-humid",
  "Rhode Island": "marine-humid",
  "South Carolina": "marine-humid",
  "South Dakota": "arid-dusty",
  Tennessee: "humid-moderate",
  Texas: "arid-dusty",
  "United States Virgin Islands": "marine-humid",
  Utah: "desert-flat",
  Vermont: "rainy-steep",
  Virginia: "humid-moderate",
  Washington: "rainy-steep",
  "West Virginia": "rainy-steep",
  Wisconsin: "temperate",
  Wyoming: "arid-dusty"
};
...
function pvgisCountryTilt(name: string) {
  return pvgisCountryTiltByName[normalizedCountryName(name)];
}

function pvgisStateTilt(name: string) {
  return pvgisStateTiltByName[normalizedCountryName(name)];
}

function countryCategory(name: string) {
  return countryCategoryByName[normalizedCountryName(name)];
}

function stateCategory(name: string) {
  return stateCategoryByName[normalizedCountryName(name)];
}
...
function classifyCountry(name: string, latitude: number): CategoryId {
  const researchedCategory = countryCategory(name);
  if (researchedCategory) return researchedCategory;
...
function classifyState(name: string): CategoryId {
  const researchedCategory = stateCategory(name);
  if (researchedCategory) return researchedCategory;
...
function buildRecommendation({
  ...
  return {
    ...
    latitude,
    longitude,
    tilt: pvgisTilt ?? estimatedAnnualTilt(latitude, category),
